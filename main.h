...
/**
 * struct format - parameter structure
 *
 * @fmt: the format
...
int flags, int width, int precision, int size);
int print_hexa(va_list types, char buffer[], char map_to[],
int flags, int width, int precision, int size);
...
int flags, int width, int precision, int size);
write_number(int is_positive, int ind, char buffer[],
int flags, int width, int precision, int size);
write_num(int ind, char buffer[], int flags, int width,
int precision, int length, char padd, char extra_c);
write_ pointer(char buffer[], int ind, int length, char padd,
int flags, int width, char extra_c, int padd_start);
write_unsignd(int is_negative, int ind, char buffer, int flags, int width,
